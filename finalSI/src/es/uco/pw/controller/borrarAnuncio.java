...
public class borrarAnuncio extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(aux != null)
		{
			if( aux.getFase().equals("archivado"))
			{
				AnuncioDAO.delete(id, ruta);
				mensajeNextPage = "Anuncio eliminado con éxito";
				
				int total = AnuncioDAO.count(ruta) + 1;
				Anuncio aux2 = AnuncioDAO.queryById(total, ruta);
				if(aux!=null)
				{
					AnuncioDAO.delete(total, ruta);
					aux2.setId(id);
					AnuncioDAO.save(aux2, ruta);
			...
			mensajeNextPage = "Error al eliminar el anuncio indicado";
