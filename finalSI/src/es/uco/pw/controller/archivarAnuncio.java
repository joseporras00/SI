 ...
 */
@WebServlet("/archivarAnuncio")
public class archivarAnuncio extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(aux != null)
		{
			if(aux.getFase().equals("editado") || aux.getFase().equals("publicado") || aux.getFase().equals("en_espera"))
				aux.setFase("archivado");
			
			AnuncioDAO.update(aux, ruta);
			mensajeNextPage = "Anuncio archivado con éxito";
		}
